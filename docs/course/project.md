...
![Sơ đồ kiến trúc hệ thống](./references/scalable-ecommerce-web-app/architecture.png)
...
> **Ghi chú của nhóm — không thuộc đề bài.** Microsoft đã gỡ bài này, link trên hiện redirect về
...
> [Architect scalable e-commerce web app](./references/scalable-ecommerce-web-app/README.md).